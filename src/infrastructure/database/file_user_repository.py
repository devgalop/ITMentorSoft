...
from src.features.user_management.shared.user import User, UserResponse, UserRole, UserStatus
...
class FileUserRepository(UserRepository):
    ...
    async def save(self, user : User):
        ...
        async with aiofiles.open(self.file_path, 'a') as f:
            await f.write(f"{user.username},{user.email},{user.password_hashed},{user.status.value},{user.role.value},{user.id}\n")
